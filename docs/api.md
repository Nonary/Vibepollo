...
- Private Linux display telemetry is not emitted by this Vibepollo backend. Clients must not
  infer support from the platform name or display configuration alone.
