...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            Vibepollo renders decoded client microphone audio into the VB-CABLE playback endpoint, and host applications
...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            On Windows, Vibepollo currently auto-detects the VB-CABLE render endpoint and this value is typically left unset.
