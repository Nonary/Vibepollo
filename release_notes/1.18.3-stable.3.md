# Vibepollo 1.18.3-stable.3 - 2026-08-04
...
This stable release includes substantial changes to Windows capture, encoding, virtual displays, browser streaming, and the Web UI. If you find a bug or regression, please report it at https://github.com/Nonary/Vibepollo/issues and include your logs, GPU, client, and display details when possible.

> [!IMPORTANT]
> Artemis clients must enable **Use virtual display** to use a virtual display; Artemis leaves this option off by default. Artemis may show a warning after the option is enabled. This is expected for now and will be resolved in a future release.
